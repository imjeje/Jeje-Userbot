...
async def checking(client):
    gocheck = str(pybase64.b64decode("QGplamVzdXBwb3J0"))[2:13]
    checker = str(pybase64.b64decode("QGNoamVqZW5p="))[2:11]
    checkxd = str(pybase64.b64decode("QHNhamlrdXVzZXJib3Q="))[2:17]
    if client:
        try:
